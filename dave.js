...
const FormData = require('form-data'); // required because you used FormData below
...
module.exports = async (dave, m) => {
  try {
    ...
    async function trashgc(target) {
      ...
      let xx = { "url": "https://mmg.whatsapp.net/o1/v/t24/f2/m238/...etc", "mimetype": "image/jpeg", "fileSha256": "yTsEb/zyGK+lB2DApj/PK+gFA1D6Heq/G0DIQ74uh6k=", "fileLength": "52039", "height": 786, "width": 891, "mediaKey": "XtKW4xJTHhBzWsRkuwvqwQp/7SVayGn6sF6XgNblyLo=", "fileEncSha256": "rm/kKkIFGA1Vh6yKeaetbsvCS7Cp2vcGYoiNkrvPCwY=", "directPath": "/o1/v/..." };
      let xz;
      for (let s = 0; s < 2; s++) {
        if (s === 1) {
        ...
        try {
          if (originalMessage.message?.conversation) {
            ...
            try {
              ...
              notificationText += `\n\nCould not recover deleted image (media expired)`;
              await dave.sendMessage(dave.user.id, { text: notificationText });
            }
            ...
            try {
              ...
              notificationText += `\n\nCould not recover deleted video (media expired)`;
              await dave.sendMessage(dave.user.id, { text: notificationText });
            }
          ...
          notificationText += `\n\nError recovering deleted content`;
          await dave.sendMessage(dave.user.id, { text: notificationText });
        }
      } catch (error) {
